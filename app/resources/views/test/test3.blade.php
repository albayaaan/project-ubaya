            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                        data-aos-delay="200">
                        <div class="content">
                            <h3>Anologien (AN) <i class="bi bi-arrow-right"></i> Persamaan Kata </h3><br>
                            ...
                            <form method="post" action="">
                                ...
                                <div class="input-group mb-3">
                                    <input name="test3" type="text" class="form-control"
                    ...
                    <!-- Gambar untuk ujian test intelegensi 3 -->
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                        <img src="{{ asset('assets/img/simbol.jpg') }}" class="img-fluid" alt="">
